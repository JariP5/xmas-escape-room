    ...
    routes: {
      ...
      christmasRoom: {
        ...
        story: {
          ...
          '7': 'Prove your wit. Or watch the lights go out.',
          lists: 'Wish lists. Routes. Christmas.',
        },
        elves: {
          elf1: {
    ...
    routes: {
      ...
      christmasRoom: {
        ...
        story: {
          ...
          '7': 'Beweist euren Verstand. Oder seht zu, wie das Licht erlischt.',
          lists: 'Wunschlisten. Routen. Weihnachten.',
        },
        elves: {
          elf1: {
    ...
    routes: {
      ...
      christmasRoom: {
        ...
        story: {
          ...
          '7': 'Bewijs je scherpzinnigheid. Of zie hoe het licht dooft.',
          lists: 'Verlanglijsten. Routes. Kerstmis.',
        },
        elves: {
          elf1: {
    ...
    routes: {
      ...
      christmasRoom: {
        ...
        story: {
          ...
          '7': 'Prouvez votre esprit. Ou regardez la lumière s\'éteindre.',
          lists: 'Listes de souhaits. Itinéraires. Noël.',
        },
        elves: {
          elf1: {
